...
import com.insuk.bookapi.book.dto.BookDto;
...
public class BookServiceTest {
    ...
    @Test
    public void 도서검색API_json_To_Dto() throws IOException, JsonParseException {
        ...
        assertThat(this.json.parseObject(bookApicontent).getIsbn()).isNull();
    }
